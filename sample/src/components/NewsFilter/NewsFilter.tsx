...
const NewsFilter = ({ listoftopic, submitFunc }: any) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {colorMode === "light" ? (
            <LightCalendarIcon data-testid="news-filterd-date-picker-light-calendar-icon" />
          ) : (
            <DarkCalendarIcon data-testid="news-filter-date-picker-dark-calendar-icon" />
          )}
        </Box>
        {datesDropdown ? (
          <Box
      ...
      <Flex direction="column" data-testid="news-filter-topics-flex">
        ...
        >
          ...
          {colorMode === "light" ? (
            <LightDropdownIcon data-testid="news-filter-topics-light-dropdown-icon" />
          ) : (
            <DarkDropdownIcon data-testid="news-filter-topics-dark-dropdown-icon" />
          )}
        </Box>
        {topicsDropdown ? (
          <Box
