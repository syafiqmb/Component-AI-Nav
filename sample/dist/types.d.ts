...
declare const GridNewsItem: ({
  item,
  openDetail,
}: any) => react_jsx_runtime.JSX.Element;

declare const NewsDetails: ({
  data,
  isOpen,
  onClose,
  onBack,
...
export {
  ...
  GridNewsItem,
  News,
  NewsDetails as NewsDetail,
  NewsFilter,
  RelatedArticles,
  RelatedArticlesDrawer,
};
